    ...
    <body>
        ...
        <form action="estadoPublicacion.jsp" method="POST">
            ...
            <div class="container">
                ...
                <div class="col-md-1"><h4>Desde: </h4></div>
                ...
                <div class="col-md-1"><h4>Hasta: </h4></div>
        ...
        <%
            out.println("<div class=\"col-md-10\"><center><button class=\"btn btn-default\" type=\"submit\" name=\"Submit\" onclick=\"this.form.action='estadoPublicacion.jsp';this.form.submit();\" value=\"" + Cod + "\">Publicar</button></center></div>");
        %>
    </form>
    <%} else {%>
    <form action="estadoPublicacion.jsp" method="POST">
