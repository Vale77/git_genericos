...
/*    ResultSet rsC = co.prepareStatement("SELECT * FROM UTIC.SATURN_SPRIDEN").executeQuery();
           ...
           catch (Exception ex)
           {
            ...
            try {
                String sql = "INSERT INTO UTIC.UZGTFORMULARIO_PERSONA (SPRIDEN_PIDM,CODIGO_UZGTFORMULARIOS_PERSONA,CODIGO_UZGTFORMULARIOS,UZGTFORMULARIOS_ESTADO_SEG, UZGTFORMULARIOS_ESTADO_LLENADO) VALUES (?,?,?,?,?)";
                PreparedStatement ps = co.prepareStatement(sql);
                for (int i = 0; i < listaPIDM.size(); i++) {
                    ps.setInt(1, listaPIDM.get(i));
                    ps.setInt(2, cod + i);
            ...
            try {
                ...
                //co.prepareStatement("UPDATE UTIC.UZGTFORMULARIOS SET  UZGTFORMULARIOS_FECHA_INICIO='" + diaInicio+"/"+mesI +"/"+anioInicio +"' WHERE CODIGO_UZGTFORMULARIOS ="+codF+"").executeUpdate();
                out.println("Exito Publicado");
