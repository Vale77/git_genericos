                ...
                <div class="container" class="col-md-10">
                    <%
                            ...
                            for (int i = 0; i < listaG.size(); i++) {
                                ...
                                out.println("<div class=\"row\">");
                                out.println("<div class=\"col-md-3\"></div>");
                                out.println("<div class=\"col-md-6\"><h6 class=\"text-success text-uppercase\">" + " *" + listaG.get(i).getDescripcion_grupo() + "</h6></div>");
                                out.println("</div>");
                                ...
                                for (int j = 0; j < listaP.size(); j++) {
                                    if (listaP.get(j).getCodigo_grupo() == listaG.get(i).getCodigo_grupo()) {
                                        ...
                                        if (listaP.get(j).getCodigo_tipo_pregunta() == 1) {
                                            ...
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("<div class=\"col-md-6 col-md-offset-3\">" + listaR.get(codR).getValor_Respuestas() + "</div>");
                                            //
                                            out.println("</div>");
                                            //numT1++;
                                            codR++;
                                        ...
                                        if (listaP.get(j).getCodigo_tipo_pregunta() == 9) {
                                            ...
                                            out.println("<div class=\"col-md-3\"></div>");
                                            out.println("<div class=\"col-md-6 col-md-offset-3\">" + listaR.get(j).getValor_Respuestas() + "</div>");
                                            //
                                            out.println("</div>");
                                            numDC++;
                                            codR++;
                                            ...
                                            for (int k = 0; k < listaV.size(); k++) {
                                                ...
                                                if (listaV.get(k).getCodigo_Preguntas() == listaP.get(j).getCodigo_preguntas()) {
                                                    ...
                                                    if (listaV.get(k).getValores().equals(listaR.get(codR).getValor_Respuestas())) {
                                                        ...
                                                        out.println("<div class=\"row\">");
                                                        out.println("<div class=\"col-md-3\"></div>");
                                                        out.println("<div class=\"col-md-6 col-md-offset-3\">" + listaV.get(k).getValores() + "</div>");
                                                        out.println("<div class=\"col-md-3\"></div>");
                                                        out.println("</div>");
                                                        codR++;
                                                    }
