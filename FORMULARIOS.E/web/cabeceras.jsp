    ...
    <body>
        ...
        <%      request.setCharacterEncoding("UTF-8");
            ...
            for (int i = 0; i < ListaMatriz.getLast().getColumna(); i++) {
                ...
                out.println("<div class=\"row\">");
                out.println("<div class=\"col-md-3\"></div>");
                out.println("<div class=\"col-md-3\"><input type=\"text\" name='" + cabecera + i + "' placeholder='" + cabecera + i + "'></div>");
                out.println("</div>");
            }
            out.println("<div class=\"row\">");
            out.println("<div class=\"col-md-3\"></div>");
            ...
            out.println("<div class=\"row\">");
            out.println("<div class=\"col-md-3\"></div>");
            out.println("<div class=\"col-md-3\"><button class=\"btn btn-default\" type=\"submit\" name=\"Submit\" value=\"guardar\">Aceptar</button></div>");
            out.println("</div>");
            out.println("</form>");
            con.closeConexion();
        %>
